    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-2 d-flex flex-column">
                <button class="btn btn-info mb-2">Action 1</button>
                <button class="btn btn-info mb-2">Action 2</button>
                <button class="btn btn-info mb-2">Action 3</button>
            </div>            
        </div>
        <!-- Fourth Row -->
        <div class="row">
            <div class="col-10">
                <p>Sum of networth: <span id="sumField1"><?php echo $networth_sum; ?></span></p>
            </div>
            <div class="col-2">
                <hr>
            </div>
