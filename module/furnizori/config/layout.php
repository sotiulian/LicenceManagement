    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-2 d-flex flex-column">
                <button class="btn btn-info mb-2" onclick="window.location.href='create_one.php'">Create furnizor</button>
            </div>            
        </div>
        <!-- Fourth Row -->
        <div class="row">
            <div class="col-10">
                <p>Row count: <span id="sumField1"><?php echo $row_count; ?></span></p>
            </div>
            <div class="col-2">
                <hr>
            </div>
