...
<body>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <button class="btn btn-info mb-2" onclick="window.location.href='create_one.php'">Create group</button>
            </div>            
        </div>
        <!-- Fourth Row -->
        <div class="row">
            <div class="col-5">
                <p>No. of Admin: <span id="sumField1"><?php echo $admin_sum; ?></span></p>
            </div>
            <div class="col-5">
                <p>No. of SysAdmin: <span id="sumField2"><?php echo $sysadmin_sum; ?></span></p>
            </div>
        </div>
        <!-- Fifth Row -->
        <div class="row">
